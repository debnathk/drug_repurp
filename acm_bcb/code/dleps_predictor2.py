...
class DLEPS(object):
    ...
    def _build_model(self):
        ...
        z_mn, z_var = self.grammar_model.vae.encoderMV.output
        output = Lambda(sampling, output_shape=(56,), name='lambda')([z_mn, z_var])
        model = Model(inputs = self.grammar_model.vae.encoderMV.input, outputs = output)
