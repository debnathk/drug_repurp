...
class DLEPS(object):
    ...
    def _build_model(self):
        ...
        drop_1s = Dropout(0.4)(dense_11s)
        dense_12s = Dense(512, activation='relu')(drop_1s)
        drop_2s = Dropout(0.4)(dense_12s)
        dense_13s = Dense(256, activation='relu')(drop_2s)
        drop_3s = Dropout(0.4)(dense_13s)
        dense_14s = Dense(128, activation='relu')(drop_3s)
        drop_4s = Dropout(0.4)(dense_14s)
        ...
        model = Model(inputs=[visible_1s, visible_1, grammar_model.vae.encoderMV.input], outputs = outputs)
